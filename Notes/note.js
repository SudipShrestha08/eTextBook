const Selection = (function() {
    function takeNote(text) {
      let card = document.createElement('div');
        ...
        card.style.backgroundColor ="#FDFBE6";
      ...
      let colorPicker = document.createElement('div');
        ...
        colorPicker.style.right = '7px';
        colorPicker.style.width = '132px';
        colorPicker.style.height = '30px';
        colorPicker.style.display = 'flex';
        colorPicker.style.background = 'none';
        
        let color1 = document.createElement('button');
            color1.style.width = '28px';
            color1.style.height = '28px';
            color1.style.borderRadius = '50%';
            color1.style.background = '#FFF5B9';
            color1.style.border = '2px solid #FAE489';
            color1.style.margin = '3px';
             
            color1.addEventListener('click', function() {
              card.style.background = '#FFF5B9';
            });  

        let color2 = document.createElement('button');
            color2.style.width = '28px';
            color2.style.height = '28px';
            color2.style.borderRadius = '50%';
            color2.style.background = '#FFC7C5';
            color2.style.border = '2px solid #C5563C';
            color2.style.margin = '3px';

            color2.addEventListener('click', function() {
              card.style.background = '#FFC7C5';
            });  

        let color3 = document.createElement('button');
            color3.style.width = '28px';
            color3.style.height = '28px';
            color3.style.borderRadius = '50%';
            color3.style.background = '#D8CAFD';
            color3.style.border = '2px solid #704BEE';
            color3.style.margin = '3px';

            color3.addEventListener('click', function() {
              card.style.background = '#D8CAFD';
            });  

        let color4 = document.createElement('button');
            color4.style.width = '28px';
            color4.style.height = '28px';
            color4.style.borderRadius = '50%';
            color4.style.background = '#BAF4D9';
            color4.style.border = '2px solid #79AED2';
            color4.style.margin = '3px';

            color4.addEventListener('click', function() {
              card.style.background = '#BAF4D9';
            });  

        colorPicker.appendChild(color1);
        colorPicker.appendChild(color2);
        colorPicker.appendChild(color3);
        colorPicker.appendChild(color4);

      let label = document.createElement('h4');
        label.style.color ="#7B7D81";
        label.style.position = 'absolute';
        label.style.top = "50px";
        label.innerText = 'Comment (Optional)';
      ...
      let textArea = document.createElement('textarea');
        ...
        textArea.style.border = '2px solid #BEC2C8';
        textArea.style.outline = 'none';
        textArea.style.boxShadow = 'none';
        textArea.style.overflow = 'hidden';
        textArea.style.background = '#fff';
        textArea.style.borderRadius= '5px';
        textArea.style.alignSelf = 'center !important';  
        textArea.placeholder = 'Write any comments you want here';

      let saveButton = document.createElement('button');
        saveButton.type = 'button';     
        saveButton.style.color = 'white';
        saveButton.style.fontWeight = 'bold';
        saveButton.style.backgroundColor = '#714BF2';
        ...
        saveButton.style.boxShadow = '0px 5px 0px 0px rgba(179,170,179,1)';
      ...
      let cancelButton = document.createElement('button');
        ...
        cancelButton.style.marginLeft = '70px';
        cancelButton.style.color = '#8D9095';
